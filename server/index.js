...
app.get('/', (req, res) => {
    res.json('Hello welcome to my app')
})
...
app.post('/login', async (req, res) => {
    ...
    try {
        ...
        const validatePassword = (await bcrypt.compare(password, user.hased_password))
...
app.get('/gendered-users', async (req, res) => {
    ...
    try {
        ...
        const foundUsers = await await users.find(query).toArray();
